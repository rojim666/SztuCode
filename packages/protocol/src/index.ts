...
export interface ContextInjectedEvent { type: "context.injected"; run_id: string; step?: number; source: "system" | "global" | "project" | "session" | "compaction" | "intervention" | "steering"; label: string; chars: number; preview: string; text: string; ts: string }

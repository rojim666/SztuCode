...
def test_load_slash_command_prompt_by_id() -> None:
    assert "senior security engineer" in load_slash_command_prompt("security-review")
    assert "Git Safety Protocol" in load_slash_command_prompt("git-commit")
...
def test_slash_command_prompts_are_not_injected_into_main_prompt() -> None:
    marker = "senior security engineer"
